...
public class UpdateUserInfoActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(requestCode==CHANGE_NICKNAME){
			changeUserInfoShowTv.setText(getResources().getString(R.string.toast_goodname_to_remember));
		}else if(requestCode==CHANGE_PERSON_STATE){
			changeUserInfoShowTv.setText(getResources().getString(R.string.toast_change_person_state));
		}
	}
